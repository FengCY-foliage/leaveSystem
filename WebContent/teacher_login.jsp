...
<body style="background-color:#f2f9fd;">
	...
	<div class="leftnav">
		...
		<ul style="display:block">
			<li><a href="leave_list_teacher.jsp" target="right"><span
					class="icon-caret-right"></span>请假单列表</a></li>
					<li><a href="leave_shenhe_teacher.jsp" target="right"><span
					class="icon-caret-right"></span>审核请假单</a></li>
		</ul>
	</div>
