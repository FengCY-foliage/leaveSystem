...
<body style="background-color:#f2f9fd;">
	...
	<div class="leftnav">
		...
		<ul style="display:block">
			<li><a href="student_list.jsp" target="right"><span
					class="icon-caret-right"></span>学生信息列表</a></li>
					<li><a href="teacher_list.jsp" target="right"><span
					class="icon-caret-right"></span>教师信息列表</a></li>
					<li><a href="admin_list.jsp" target="right"><span
					class="icon-caret-right"></span>管理员信息列表</a></li>
		</ul>
	</div>
