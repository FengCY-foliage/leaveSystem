...
<div class="panel admin-panel">
			...
			<table class="table table-hover text-center">
				...
				<tr>
					...
					<% ArrayList<leaveListBean> list= leaveListDao.findLeaveListShenhe(); %>
					<% for(int i = 0;i<list.size();i++) {
						...
						<div class="button-group">
								...
								href="shenheServlet?1&&<% out.println(list.get(i).getId()); %>"><span
								class="icon-edit"></span> 同意</a> 
								<a class="button border-red"
								href="shenheServlet?2&&<% out.println(list.get(i).getId()); %>"><span
								class="icon-trash-o"></span> 拒绝</a>
						</div>
						</td>
						<%
						out.println("</tr>");
