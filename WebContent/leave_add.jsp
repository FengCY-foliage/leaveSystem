			...
			<form method="post" class="form-x"
				...
				<div class="form-group">
					...
					<div class="field" style="width:600px;">
						<textarea class="input" name="because"  style="height:90px;"></textarea>
						<div class="tips"></div>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="field">
						<input type="text" class="input w50" value="" name="day"
				...
				<div class="form-group" >
					...
					<div class="field" >
						<input  id="clock" type="datetime-local" class="input w50"  value="" name="shenqingData"
							data-validate="required:数据必填项" />
						<div class="tips"></div>
					</div>
				</div>
